    ...
    <div className="flex flex-1 items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4 py-12 transition-colors">
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-zinc-600 dark:text-zinc-400">Masuk ke akunmu</p>
        </div>

        {/* Form */}
        <form onSubmit={handleLogin} className="space-y-4 rounded-2xl bg-white dark:bg-zinc-900 p-6 shadow-sm ring-1 ring-zinc-200 dark:ring-zinc-800 transition-colors">
          {error && (
        ...
        <p className="text-center text-sm text-zinc-600 dark:text-zinc-400">
          Belum punya akun?{" "}
          <Link href="/auth/signup" className="font-medium text-zinc-900 dark:text-zinc-100 underline underline-offset-4">
            Daftar
          </Link>
        </p>
      </div>
