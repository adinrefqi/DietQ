    ...
    <div className="flex flex-1 items-center justify-center bg-zinc-50 px-4 py-12">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-zinc-600">Masuk ke akunmu</p>
        </div>

        {/* Form */}
        <form onSubmit={handleLogin} className="space-y-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-zinc-200">
          {error && (
        ...
        <p className="text-center text-sm text-zinc-600">
          Belum punya akun?{" "}
          <Link href="/auth/signup" className="font-medium text-zinc-900 underline underline-offset-4">
            Daftar
          </Link>
        </p>
      </div>
